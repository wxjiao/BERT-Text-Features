#########################################################################################
# Script name: extract_functions.py
# Author: Modified from [https://github.com/huggingface/pytorch-transformers/blob/v0.6.2/examples/extract_features.py]
#         Change the main function of original to callable function.
# Date: 2019-08-12
# Function:
...
def extract_features(input_file, output_file, bert_model, do_lower_case=True, layers="-1,-2,-3,-4", max_seq_length=128, batch_size=32, local_rank=-1, no_cuda=False):
	...
	#             Locally saved pre-trained Bert: ./pretrained_model_bert
	# do_lower_case: True, if you are using an uncased model.
	# layers: "-1,-2,-3,-4"
